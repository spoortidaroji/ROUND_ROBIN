...
char line1[] = {"Alvas Institute of Engineering & Technology"};
char line2[] = {"Computer Science Department"};
char line3[] = {"   Computer Graphics project"};
char line4[] = {"Topic:Time Scheduling Algorithm"};
char line5[] = {"Pramod P M: 4AL18CS058"};
char line6[] = {"Spoorti S Daroji: 4AL18CS088"};
char line7[] = {"(Press 1 to enter the main page)"};
char op[] = {"Options:"};
char op1[] = {"1. Round Robin (RR)"};
...
{
    glClear(GL_COLOR_BUFFER_BIT);
    displayText(600, 200, 1, 1, 1,op3);
    displayText(600, 230, 1, 1, 1,op2);
    displayText(600, 290, 1, 1, 1,op1);
...
int main(int argc,char** argv)
{
    ...
    wid =  glutCreateWindow("Time Scheduling Algorithm");
    init();
